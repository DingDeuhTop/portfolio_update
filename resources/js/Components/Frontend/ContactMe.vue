    ...
    <section id="contact" class="section bg-light-primary dark:bg-dark-primary">
        <div class="container mx-auto">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="subtitle">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum alias delectus quod eligendi sequi
                    quisquam esse explicabo a sit necessitatibus consequuntur omnis, voluptatem quis, magnam facilis
                    illo tenetur. Minus, praesentium?
                </p>
            </div>
            ...
            ">
                    ...
                    <textarea v-model="form.body" class="textarea" placeholder="Your Meassage"
